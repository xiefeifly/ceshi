<template>
  <div id="suspend">
    ...
    <div id="suspend_t_g_scroll">
      <div id="suspend_t_list" v-for="(item,index) in list" v-bind:key="item.id">
        <div id="suspend_t_item_l">
          <div id="suspend_t_item">工票号：{{item.shuzi}}</div>
          <div id="suspend_t_item">件号：{{item.shuzi}}</div>
          <div id="suspend_t_item">车号：{{item.shuzi}}</div>
          <div id="suspend_t_item">列号：{{item.shuzi}}</div>
          <div id="suspend_t_item">数量：{{item.shuzi}}</div>
          <div id="suspend_t_item">工艺时长：{{item.shuzi}}</div>
        </div>
    ...
    <div id="suspend_t_r_scroll">
      <div id="suspend_r_list" v-for="(item,index) in list" v-bind:key="item.id">
        <div id="suspend_t_item">姓名：{{item.shuzi}}</div>
        <div id="suspend_t_item">卡号：{{item.shuzi}}</div>
        <div id="suspend_t_checkbox">
          <input
            name="Fruit"
            type="checkbox"
    ...
    <div id="suspend_input">暂停原因：
      <input style="width:75% ;height:100%;" type="number" v-model="tianjia" />
    </div>
